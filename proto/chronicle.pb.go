...
var file_proto_chronicle_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x22, 0x23, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a,
	...
	0x09, 0x43, 0x68, 0x72, 0x6f, 0x6e, 0x69, 0x63, 0x6c, 0x65, 0x12, 0x2f, 0x0a, 0x02, 0x44, 0x6f,
	0x12, 0x12, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6e, 0x69, 0x63, 0x6c, 0x65, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6e, 0x69, 0x63, 0x6c, 0x65,
...
var file_proto_chronicle_proto_depIdxs = []int32{
	0, // 0: chronicle.Chronicle.Do:input_type -> chronicle.Request
	1, // 1: chronicle.Chronicle.Do:output_type -> chronicle.Response
...
// ChronicleClient is the client API for Chronicle service.
//
...
func NewChronicleClient(cc grpc.ClientConnInterface) ChronicleClient {
	return &chronicleClient{cc}
}

func (c *chronicleClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/chronicle.Chronicle/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ChronicleServer is the server API for Chronicle service.
type ChronicleServer interface {
	Do(context.Context, *Request) (*Response, error)
}

// UnimplementedChronicleServer can be embedded to have forward compatible implementations.
type UnimplementedChronicleServer struct {
}

func (*UnimplementedChronicleServer) Do(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Do not implemented")
}

func RegisterChronicleServer(s *grpc.Server, srv ChronicleServer) {
	s.RegisterService(&_Chronicle_serviceDesc, srv)
}

func _Chronicle_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChronicleServer).Do(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chronicle.Chronicle/Do",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChronicleServer).Do(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _Chronicle_serviceDesc = grpc.ServiceDesc{
	ServiceName: "chronicle.Chronicle",
	HandlerType: (*ChronicleServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Do",
			Handler:    _Chronicle_Do_Handler,
		},
	},
